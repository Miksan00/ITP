	...
	<section id="header">
		...
		<div>
			<ul id="navbar">
				...
				<li><a href="EM_employeeLogin.jsp">Logout</a></li>
			</ul>
...
<div class="aa">
<a href="EM_viewReq.jsp">View Requests</a>
</div>
<br>
<%
...
%>
<div class="container">
<h1>Enter Your Details To Request a Leave</h1>
<br>
<form action="EM_applyLeaveAction.jsp" method="post">
<h2>ID</h2>
...
<hr>
<h2>Leave Date</h2>
<input type="date" placeholder="Select Your Leave Date" name="date" required pattern="\d{4}-\d{2}-\d{2}" id="myDate">
<hr>
<h2>Phone Number</h2>
...
<hr>
<h2>Reason</h2>
<input type="text" placeholder="Enter Your Reason" name="reason" required onkeyup="validateReasons(this)">
...
<script>
    ...
    function validateReasons(input) {
