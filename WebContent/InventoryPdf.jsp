...
<body>
	...
	Phrase name = new Phrase("Inventory Name", boldFont);
	Phrase suppliername = new Phrase("Supplier Name", boldFont);
	Phrase id = new Phrase("Supplier Id", boldFont);
	Phrase date = new Phrase("Supplied Date", boldFont);
	Phrase quantity = new Phrase("Quantity", boldFont);
	Phrase price = new Phrase("Price", boldFont);
	table1.addCell(name);
	...
	while (rs.next()) {
		...
		p3.add(rs.getString("inventoryname"));
		p4.add(rs.getString("suppliername"));
		p5.add(rs.getString("supllierid"));
		p6.add(rs.getString("supplierdate"));
		p7.add(rs.getString("quantity"));
		p8.add(rs.getString("price"));
