...
<body>
	...
	Paragraph p6 = null;
	Paragraph p7 = null;
	float[] colsWidth = { 1f, 1f, 1f, 1f,1f }; // Code 1
	...
	Phrase Guest = new Phrase("Guest", boldFont);
	Phrase Mobile = new Phrase("Mobile", boldFont);
	Phrase facilities = new Phrase("Additional Service", boldFont);
	Phrase decoration = new Phrase("Decoration", boldFont);
	Phrase date = new Phrase("Date", boldFont);
	table1.addCell(Guest);
	table1.addCell(Mobile);
	table1.addCell(facilities);
	table1.addCell(decoration);
	table1.addCell(date);
	...
	while (rs.next()) {
		...
		p6 = new Paragraph();
		p7 = new Paragraph();
		p3.add(rs.getString("guest"));
		p4.add(rs.getString("mobile"));
		p5.add(rs.getString("additional"));
		p6.add(rs.getString("decoration"));
		p7.add(rs.getString("Date"));
