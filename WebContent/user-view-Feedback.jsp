...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container">
			<a class="navbar-brand" href="FeedbackController"><img Style="max-width:148px;" src="images/Logo.jpg"></a>
			...
			<a class="nav-link" href="${listLink}" style="color: #F1F1F1;"><i class="fas fa-sign-out-alt"></i> Load Comments</a>
				</li>
			</ul>
		</div>
	</nav>
	...
	<div class="container" style="text-align:center; padding-top: 10px;">
		...
		<div class="row">
			<div class="col-sm-6">
				<form action="FeedbackController" method="get" class="form-horizontal" style="padding: 10px 0 10px 0;">
					<div class="input-group">
						...
						<div class="input-group-append">
							<c:url var="searchLink" value="FeedbackController">
			...
			<div class="col-sm-6" style="padding: 10px 15px 10px 15px;">
				<c:url var="checkLink" value="FeedbackController">
		...
		<div class="table-responsive">
			<table class="table table-striped table-hover" style="width:150%;">
				...
				<tbody>
					...
					<c:forEach var="tempItem" items="${ ROOM_LIST }">
						<c:url var="updateLink" value="FeedbackController">
							<c:param name="COMMAND" value="LOAD"/>
							<c:param name="id" value="${tempItem.id}"/>
						</c:url>
						<c:url var="deleteLink" value="FeedbackController">
