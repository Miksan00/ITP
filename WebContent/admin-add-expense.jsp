...
<div class="header"><a href="#default" class="logo"><img Style="max-width:148px" src="images/v1.jpg"></a> 
  ...
  justify-content: center;">
			<h2 style="font-family:courier;"><b>Add Expenses</b></h2>
		</div>

<div class="container" style="max-width: 700px; max-height:1000px;  margin-top:20px; box-shadow: 5px 10px 18px #F1F1F1;background: #08877;">
...
  					<label for="Inventory" >Inventory</label><br>
				...
				<div class="form-group">
				<label>Type:<br>
					<input placeholder="Choose Type" list="types" name="type" style="width:670px" required="required"></label>
						<datalist id="types">
  						<option value="Chair">
  						<option value="Food">
  						<option value="E-bill">
				...
				<div class="form-group">
					...
					<input type="number" id="Quantity" name="quantity" placeholder="Enter Quantity" required ="required" onchange="calculateAmount(this.value)" class="form-control" required="required" >
				</div>
				
				<div class="form-group">
					<label for="inputTotal">Total: </label>
					<input type="number" id="tot_amount" name="total"  class="form-control" required="required" readonly>
				</div>
				<div class="form-group">
