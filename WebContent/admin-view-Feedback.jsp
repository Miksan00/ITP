...
<body>
	...
	<nav class="navbar navbar-light" style="background-color:#dfe0d5;">
		<div class="container">
			...
			<table id="tab-01" class="table table-striped table-hover" style="width:150%;">
				...
				<tbody>
					...
					<c:forEach var="tempItem" items="${ ROOM_LIST }">
						<c:url var="updateLink" value="AdminFeedbackController">
							<c:param name="COMMAND" value="LOAD"/>
							<c:param name="id" value="${tempItem.id}"/>
						</c:url>
						<c:url var="deleteLink" value="AdminFeedbackController">
