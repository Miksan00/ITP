...
try
{
	...
	ResultSet rs=st.executeQuery("select *from salaryinfo where id");
	while(rs.next())
	{
%>
<div class="container">
<form action="EM_updateSalaryAction.jsp" method="post">
<hr>
<h2>ID</h2>
<input type="number" value="<%=rs.getString(1)%>" name="id" required>
<hr>
<h2>Name</h2>
<input type="text" value="<%=rs.getString(2)%>" name="name" required>
<hr>
<h2>City</h2>
<input type="text" value="<%=rs.getString(3)%>" name="city" required>
<hr>
<h2>Phone Number</h2>
<input type="number" value="<%=rs.getString(4)%>" name="phonenumber" required>
<hr>
<h2>Salary</h2>
<input type="number" value="<%=rs.getString(6)%>" name="salary" required>
<br>
<br>
<br>
