...
<body>
	...
	Phrase name = new Phrase("Veichle Name", boldFont);
	Phrase Facilities = new Phrase("Facilities", boldFont);
	Phrase main = new Phrase("Cost Per day", boldFont);
	Phrase type = new Phrase("Veichle type", boldFont);
	...
	while (rs.next()) {
		...
		p3.add(rs.getString("v_name"));
		p4.add(rs.getString("facilities"));
		p5.add(rs.getString("costperday"));
		p6.add(rs.getString("veichletype"));
