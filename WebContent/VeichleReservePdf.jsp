...
<body>
	...
	p.add("Veichle Reservation List");
	...
	String query = "select * from veichlereservation";
	Statement stmt = null;
	...
	Phrase nic = new Phrase("Nic", boldFont);
	Phrase email = new Phrase("Email", boldFont);
	Phrase checkin = new Phrase("Check In", boldFont);
	
	Phrase cost = new Phrase("Cost", boldFont);
	table1.addCell(name);
	table1.addCell(nic);
	table1.addCell(email);
	table1.addCell(checkin);
