	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<c:url var="listLink" value="FeedbackController">
					<c:param name="COMMAND" value="LIST"/>
				</c:url>
			<a class="nav-link" href="${listLink}" style="color: #F1F1F1;"><i class="fas fa-sign-out-alt"></i> View Comments</a>
				</li>
	   ...
	   <h1 style="text-align:center">Online Feedback Form</h1>
       <p style="text-align:center">Thank you for taking the time to fill in our online feedback form. By providing us your feedback, you are helping us understand what we do well and what improvements we need to implement.</p>
		...
		<div>
			<form action="FeedbackController" method="get">
				...
				<div class="form-group">
					...
					<textarea rows="4" cols="50"id="address" name="address" placeholder=" Add Comment" class="form-control" required="required"></textarea>
					<!-- <input type="text" id="address" name="address" placeholder=" Add Comment" class="form-control" required="required"> -->
				</div>
				
				
				
				<div class="form-group">
					<label for="inputDOA">Date: </label>
				...
				<div class="row">
					<div class="col text-center">
						<input type="submit" value="Comment" class="btn btn-success btn-block">
					</div>
				</div>
